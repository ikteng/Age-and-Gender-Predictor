...
3. Download the Dataset
    This project uses the UTKFace dataset (https://www.kaggle.com/datasets/jangedoo/utkface-new). It uses the kagglehub to download the dataset automatically when running the project!
4. Run the program
